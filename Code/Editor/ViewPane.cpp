...
void CLayoutViewPane::OnActionRegistrationHook()
{
    ...
    // Graphics Settings
    {
        constexpr AZStd::string_view actionIdentifier = "o3de.action.viewport.graphicsSettings";
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "Graphics Settings";
        actionProperties.m_iconPath = ":/stylesheet/img/UI20/Settings.svg";
    ...
    // Graphics Settings - Enable Bloom
    {
        constexpr AZStd::string_view actionIdentifier = "o3de.action.viewport.graphicsSettings.bloom";
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "Bloom";
        actionProperties.m_category = "Graphics Effects";
        ...
        m_actionManagerInterface->RegisterCheckableAction(
            ...
            []
            {
                if (auto* console = AZ::Interface<AZ::IConsole>::Get())
                {
                    ...
                    console->GetCvarValue("r_enableBloom", currentValue);
                    console->PerformCommand(currentValue ? "r_enableBloom 0" : "r_enableBloom 1");
                }
            },
            []() -> bool
            {
                ...
                if (auto* console = AZ::Interface<AZ::IConsole>::Get())
                {
                    console->GetCvarValue("r_enableBloom", value);
                }
                return value;
            }
        );
    ...
    // Graphics Settings - Enable Depth of Field
    {
        constexpr AZStd::string_view actionIdentifier = "o3de.action.viewport.graphicsSettings.dof";
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "Depth of Field";
        actionProperties.m_category = "Graphics Effects";
        ...
        m_actionManagerInterface->RegisterCheckableAction(
            ...
            []
            {
                ...
                {
                    bool currentValue = true;
                    console->GetCvarValue("r_enableDOF", currentValue);
                    console->PerformCommand(currentValue ? "r_enableDOF 0" : "r_enableDOF 1");
                }
            },
            []() -> bool
            {
                ...
                if (auto* console = AZ::Interface<AZ::IConsole>::Get())
                {
                    console->GetCvarValue("r_enableDOF", value);
                }
                return value;
            }
        );
    ...
    // Graphics Settings - Enable Fog
    {
        constexpr AZStd::string_view actionIdentifier = "o3de.action.viewport.graphicsSettings.fog";
        AzToolsFramework::ActionProperties actionProperties;
        actionProperties.m_name = "Fog";
        actionProperties.m_category = "Graphics Effects";
        ...
        m_actionManagerInterface->RegisterCheckableAction(
            ...
            []
            {
                ...
                {
                    bool currentValue = true;
                    console->GetCvarValue("r_enableFog", currentValue);
                    console->PerformCommand(currentValue ? "r_enableFog 0" : "r_enableFog 1");
                }
            },
            []() -> bool
            {
                ...
                if (auto* console = AZ::Interface<AZ::IConsole>::Get())
                {
                    console->GetCvarValue("r_enableFog", value);
                }
                return value;
            }
        );
...
void CLayoutViewPane::OnMenuBindingHook()
{
    ...
    // Graphics Settings
    {
        m_menuManagerInterface->AddActionToMenu(EditorIdentifiers::ViewportGraphicsSettingsMenuIdentifier, "o3de.action.viewport.graphicsSettings.bloom", 100);
