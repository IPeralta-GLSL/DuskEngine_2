...
public:
    ...
    CEditCommandLineInfo()
    {
        ...
        parser.setApplicationDescription(QObject::tr("Dusk Engine Editor"));
...
void CCryEditApp::OpenProjectManager(const AZStd::string& screen)
{
    ...
    if (!launchSuccess)
    {
        QMessageBox::critical(AzToolsFramework::GetActiveWindow(), QObject::tr("Failed to launch Dusk Engine Project Manager"), QObject::tr("Failed to find or start the Dusk Engine Project Manager"));
    }
}
...
void CCryEditApp::SetEditorWindowTitle(QString sTitleStr, QString sPreTitleStr, QString sPostTitleStr)
{
    if (MainWindow::instance() || m_pConsoleDialog)
    {
        ...
        {
            sTitleStr = QObject::tr("Dusk Engine Editor [%1]").arg(FormatVersion(m_pEditor->GetFileVersion()));
        }
