...
void EditorActionsHandler::OnActionContextRegistrationHook()
{
    // Main Window
    {
        ...
        contextProperties.m_name = "Dusk Engine Editor";
    ...
    {
        AzToolsFramework::ActionContextProperties contextProperties;
        contextProperties.m_name = "Dusk Engine Editor - Asset Browser";
    ...
    {
        AzToolsFramework::ActionContextProperties contextProperties;
        contextProperties.m_name = "Dusk Engine Editor - Console";
