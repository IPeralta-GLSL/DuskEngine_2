...
# set manually to allow this module to test PySide6 imports
...
# -------------------------------------------------------------------------
# QtForPython (PySide6) is a DCCsi Gem dependency
...
if DCCSI_TEST_PYSIDE:
    ...
    if not QT_PLUGIN_PATH:
        ...
        QT_PLUGIN_PATH = Path(PATH_O3DE_3RDPARTY,
                              'packages',
                              'pyside6-6.5.0.1-py3.10-rev1-windows',
                                'pyside6',
                                'lib',
                                'site-packages')
    ...
    try:
        ...
        _LOGGER.info('PySide6 bootstrapped PATH for Windows.')
    except ImportError as e:
