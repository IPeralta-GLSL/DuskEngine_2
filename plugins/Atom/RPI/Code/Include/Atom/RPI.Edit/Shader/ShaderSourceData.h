...
namespace AZ
{
    namespace RPI
    {
        ...
        struct ATOM_RPI_EDIT_API ShaderSourceData
        {
            ...
            //! Optional compiler to use: "azslc" (default) or "slang".
            //! When "slang" is specified, the SPIR-V bytecode is generated by slangc
            //! instead of DXC. The reflection JSON files are still produced by AZSLc.
