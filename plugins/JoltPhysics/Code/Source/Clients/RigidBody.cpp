...
namespace JoltPhysics
{
    ...
    RigidBody::~RigidBody()
    {
        ...
        if (m_joltRigidBody)
        {
            ...
            if (bodyInterface.IsAdded(m_joltRigidBody->GetID()))
            {
                bodyInterface.RemoveBody(m_joltRigidBody->GetID());
            }
            bodyInterface.DestroyBody(m_joltRigidBody->GetID());
            m_joltRigidBody = nullptr;
        }
    }
